  ...
  return (
    <section className="cta-banner" aria-labelledby="cta-heading">
      <div className="container cta-banner__inner">
        ...
        <div className="cta-banner__actions"><Button to="/contact">Request a Quote</Button>{whatsapp && <Button href={whatsapp} variant="secondary"><IconWhatsApp />WhatsApp Us</Button>}</div>
      </div>
    </section>
  )
}
