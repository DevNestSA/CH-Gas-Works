        ...
        <div className="container">
          <div className="section-heading">
            ...
            <h2>
              ...
              <br />
              of gas experience<span className="about-timeline__dot">.</span>
            </h2>
          </div>

          <div className="about-timeline__grid">
            <article className="about-timeline__card">
              <div className="about-timeline__top">
                <span className="about-timeline__number">01</span>
                <span className="about-timeline__line" />
              </div>

              <div className="about-timeline__year">1999</div>
              <div className="about-timeline__divider" />
            ...
            <article className="about-timeline__card">
              <div className="about-timeline__top">
                <span className="about-timeline__number">02</span>
                <span className="about-timeline__line" />
              </div>
            ...
            <article className="about-timeline__card about-timeline__card--current">
              <div className="about-timeline__top">
                <span className="about-timeline__number">03</span>
                <span className="about-timeline__line" />
              </div>
